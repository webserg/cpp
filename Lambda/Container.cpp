...
Container<double>::Container(const Container& c) : sz{ c.size() }, space{ c.size() }, elem{ new double[c.size()] } {
...
Container<double>& Container<double>::operator=(const Container& a)
{
